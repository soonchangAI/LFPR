...
org_model=/media/cybertron/fa54fcb6-b5e1-492e-978a-6389519c168a/tap_pt_model/save/finetuned/stvqa_tap_ocrcc_best.ckpt
...
if [ "$prune_heuristic" = "sum" ]; then
    ...
    retrain_set=(100 60 10 10 10 10 10)
    trainable_layers=(9 3 0 0 0 0 0)
...
model_attributes."$pruned_model_arch".mmt.mask True""" >> $output_dir/retrain_lfpr.sh     
    ...
    retrain_set=(10 10 10 10 100)
    trainable_layers=(0 0 0 0 9)
