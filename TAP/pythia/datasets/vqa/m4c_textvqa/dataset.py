...
class M4CTextVQADataset(TextVQADataset):
    def __init__(self, dataset_type, imdb_file_index, config, *args, **kwargs):
        ...
        self.data_dir = config.data_root_dir
        self.object_clsname = [x.strip() for x in list(open(self.data_dir+'/1600-400-20/objects_vocab.txt','r'))]
        ...
        if self.pretrain and self._dataset_type=='train' and self.textcap_pretrain:
            ...
            capjson = json.load(open(self.data_dir + '/original_dl/TextCaps_0.1_train.json','r'))
